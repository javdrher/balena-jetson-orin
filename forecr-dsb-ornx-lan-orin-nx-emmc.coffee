...
FLASH_TOOL = 'Unzip BalenaOS image and use <a href=\"https://github.com/balena-os/jetson-flash\">Jetson Flash</a> on branch forecr_dsboard_nx2 to provision the device.'
DONE_FLASHING  = 'After flashing is completed, please wait until the board is rebooted'
module.exports =
	version: 1
	slug: 'forecr-dsb-ornx-lan-orin-nx-emmc'
	name: 'Forecr DSBOARD ORNX LAN Orin NX eMMC'
	arch: 'aarch64'
	state: 'released'
	community: true
	...
	yocto:
		machine: 'forecr-dsb-ornx-lan-orin-nx-emmc'
		image: 'balena-image'
		fstype: 'balenaos-img'
		version: 'yocto-kirkstone'
		deployArtifact: 'balena-image-forecr-dsb-ornx-lan-orin-nx-emmc.balenaos-img'
		compressed: true
